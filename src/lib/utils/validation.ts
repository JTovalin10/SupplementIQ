import { z } from 'zod';
import { ProductCategory, IngredientType, ContributionType } from '../types';
...
export const searchFiltersSchema = z.object({
  ...
  sort_by: z.enum(['transparency', 'cost_efficiency', 'effective_protein', 'price'] as const).optional(),
...
export const blendRatioSchema = z.object({
  ...
  confidence: z.number()
    ...
    .default(0.5),
  source: z.enum(['disclosed', 'estimated', 'community_verified'] as const).default('estimated')
});
