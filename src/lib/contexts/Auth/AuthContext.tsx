...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  useEffect(() => {
    const initializeAuth = async () => {
      ...
      try {
        ...
        console.log(
          `⏱️ [AUTH] Session check took ${Date.now() - sessionStartTime}ms`,
        );
  ...
  const value: AuthContextType = {
    ...
    refreshUser,
    handleOverridePromote: (userId, targetRole) =>
      handleOverridePromote(
        userId,
        targetRole,
        permissions,
    ...
    handleApproveSubmission: (submissionId, notes) =>
      handleApproveSubmission(
        submissionId,
        notes,
        permissions,
    ...
    handleApproveProductEdit: (editId, notes) =>
      handleApproveProductEdit(
        editId,
        notes,
        permissions,
    ...
    handleRejectProductEdit: (editId, reason) =>
      handleRejectProductEdit(
        editId,
        reason,
        permissions,
