...
export { calculateDosageRating, calculateProductDosageRating } from './dosage-calculator';
export { stimulantSupplements } from './stimulants';
export { CategoryIngredients, CategorySupplements, DosageRating, IngredientField, SupplementInfo } from './types';
...
export const categoryIngredients: CategoryIngredients = {
  protein: [
    ...basicInfoIngredients.filter(ing => 
      ['serving_size_g', 'servings_per_container', 'price', 'calories', 'sugar_g', 
       'total_carbohydrate_g', 'fat_g', 'saturated_fat_g', 'fiber_g', 'sodium_mg', 
       'cholesterol_mg'].includes(ing.name)
    ),
    // Add protein-specific ingredients here
  ],
  'pre-workout': [
    ...basicInfoIngredients.filter(ing => 
      ['calories', 'serving_g', 'serving_scoops', 'sugar_g', 'total_carbohydrate_g', 
       'servings_per_container', 'price'].includes(ing.name)
    ),
  ...
  'energy-drink': [
    ...basicInfoIngredients.filter(ing => 
      ['serving_size_fl_oz', 'servings_per_container', 'price'].includes(ing.name)
    ),
...
export const creatineTypes = [
  ...
  { value: 'Creatine Alpha-Ketoglutarate', label: 'Creatine Alpha-Ketoglutarate' },
  { value: 'Creatine Taurinate', label: 'Creatine Taurinate' },
  { value: 'Creatine Ethyl Ester', label: 'Creatine Ethyl Ester' },
  { value: 'Creatine Ethyl Ester Malate', label: 'Creatine Ethyl Ester Malate' },
  { value: 'Creatine Magnesium Chelate', label: 'Creatine Magnesium Chelate' },
  { value: 'Micronized Creatine Monohydrate', label: 'Micronized Creatine Monohydrate' },
