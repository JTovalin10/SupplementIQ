...
export const creatineTypeDosages: CreatineTypeDosage[] = [
  ...
  },
  {
    ...
    dangerousDosage: 10000, // 10g+
    dosageNotes:
      "Creatine without water molecules. Same dosing as monohydrate.",
    cautions:
      "High doses (10g+) may cause GI distress, bloating, or cramping. Take with plenty of water.",
    precaution_people: [
      "kidney disease",
  ...
  },
  {
    ...
    dosageNotes:
      "Better solubility than monohydrate. Moderate dosing required.",
    cautions: "May cause mild GI upset at high doses. Take with water.",
    precaution_people: [
      "kidney disease",
      "diabetes",
  ...
  },
  {
    ...
    dangerousDosage: 10000, // 10g+
    dosageNotes:
      "Smaller particle size for better mixing. Same dosing as regular monohydrate.",
    cautions:
      "High doses (10g+) may cause GI distress, bloating, or cramping. Take with plenty of water.",
    precaution_people: [
      "kidney disease",
  ...
  },
  {
    ...
    dangerousDosage: 10000, // 10g+
    dosageNotes:
      "High-purity German creatine monohydrate. Same dosing as monohydrate.",
    cautions:
      "High doses (10g+) may cause GI distress, bloating, or cramping. Take with plenty of water.",
    precaution_people: [
      "kidney disease",
  ...
  },
  {
    ...
    dangerousDosage: 10000, // 10g+
    dosageNotes:
      "Effervescent form for better mixing. Same dosing as monohydrate.",
    cautions:
      "High doses (10g+) may cause GI distress, bloating, or cramping. Take with plenty of water.",
    precaution_people: [
      "kidney disease",
  ...
  },
  {
    ...
    cautions:
      "May cause mild GI upset at high doses. Take with water. Liquid form may degrade over time.",
    precaution_people: [
      "kidney disease",
      "diabetes",
      "bipolar disorder",
  ...
  },
  {
    ...
    maxDailyDosage: 3000, // 3g
    dangerousDosage: 6000, // 6g+
    dosageNotes: "Phosphorylated creatine.",
    cautions: "May cause mild GI upset at high doses. Take with water.",
    precaution_people: [
      "kidney disease",
      "diabetes",
...
export function getCreatineTypeDosage(
  creatineType: string,
): CreatineTypeDosage | undefined {
