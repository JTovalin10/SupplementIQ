...
const categories = [
  ...
  { id: 'pre-workout', name: 'Pre-Workout', description: 'Energy and performance supplements' },
  { id: 'bcaa', name: 'BCAA', description: 'Branched-chain amino acids' },
  { id: 'creatine', name: 'Creatine', description: 'Muscle building and strength' },
  { id: 'fat-burner', name: 'Fat Burner', description: 'Weight loss and metabolism' },
  { id: 'energy-drink', name: 'Energy Drink', description: 'Caffeine and nootropic blends' },
  { id: 'eaa', name: 'EAA', description: 'Essential amino acids' },
  { id: 'appetite-suppressant', name: 'Appetite Suppressant', description: 'Hunger control supplements' }
];
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
            {categories.map(category => (
              <div key={category.id} className="bg-white p-6 rounded-lg shadow-sm border text-center hover:shadow-md transition-shadow">
