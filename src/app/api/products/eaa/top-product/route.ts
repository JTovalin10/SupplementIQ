...
// GET /api/products/eaa/top-product
// - Returns top EAA products sorted by dosage_rating ASC, then community_rating ASC
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch EAA details' }, { status: 500 });
  }
}
