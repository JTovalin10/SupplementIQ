...
export default function OwnerStats() {
  console.log('OwnerStats component rendered');
  ...
  useEffect(() => {
    console.log('OwnerStats useEffect called, hasFetched:', hasFetchedRef.current);
    if (hasFetchedRef.current) {
      console.log('OwnerStats: Already fetched, skipping API call');
      return;
    }
    hasFetchedRef.current = true;
    console.log('OwnerStats: Making API call to recent-products');
        ...
        {isLoading ? (
          ...
          <div className="p-6">
            <div className="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-md">
              <div className="font-medium">Error loading recent products:</div>
              <div className="text-sm mt-1">{error}</div>
              <div className="text-xs mt-2 text-red-500">
                Check your authentication and try refreshing the page.
              </div>
            </div>
          </div>
