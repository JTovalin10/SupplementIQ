...
export const DOSAGE_MAPPINGS: Record<string, DosageMapping> = {
  "pre-workout": {
    ...
    l_citrulline_mg: {
      ...
      unit: "mg",
      category: "ingredient",
      description: "Nitric oxide precursor for pumps",
    },
    ...
    glycerpump_mg: {
      displayName: "GlycerPump",
      unit: "mg",
      category: "ingredient",
      description: "Glycerol for cell volumization",
    },
    betaine_anhydrous_mg: {
      displayName: "Betaine Anhydrous",
      unit: "mg",
      category: "ingredient",
      description: "Power and strength enhancement",
    },
    agmatine_sulfate_mg: {
      displayName: "Agmatine Sulfate",
      unit: "mg",
      category: "ingredient",
      description: "Nitric oxide enhancement",
    },
    l_tyrosine_mg: {
    ...
    caffeine_anhydrous_mg: {
      displayName: "Caffeine Anhydrous",
      unit: "mg",
      category: "ingredient",
      description: "Energy and alertness",
    },
    n_phenethyl_dimethylamine_citrate_mg: {
      displayName: "N-Phenethyl Dimethylamine Citrate",
      unit: "mg",
      category: "ingredient",
      description: "Stimulant and focus",
    },
    kanna_extract_mg: {
      displayName: "Kanna Extract",
      unit: "mg",
      category: "ingredient",
      description: "Mood enhancement",
    },
    huperzine_a_mcg: {
    ...
    bioperine_mg: {
      displayName: "Bioperine",
      unit: "mg",
      category: "ingredient",
      description: "Absorption enhancement",
    },
  },
  ...
  "non-stim-pre-workout": {
    ...
    l_citrulline_mg: {
      ...
      unit: "mg",
      category: "ingredient",
      description: "Nitric oxide precursor",
    },
    creatine_monohydrate_mg: {
      displayName: "Creatine Monohydrate",
      unit: "mg",
      category: "ingredient",
      description: "Strength enhancement",
    },
    betaine_anhydrous_mg: {
      displayName: "Betaine Anhydrous",
      unit: "mg",
    ...
    glycerol_powder_mg: {
      displayName: "Glycerol Powder",
      unit: "mg",
      category: "ingredient",
      description: "Cell volumization",
    },
    malic_acid_mg: {
    ...
    taurine_mg: {
      ...
      unit: "mg",
      category: "ingredient",
      description: "Hydration and performance",
    },
    sodium_nitrate_mg: {
  ...
  "energy-drink": {
    ...
    n_acetyl_l_tyrosine_mg: {
      displayName: "N-Acetyl L-Tyrosine",
      unit: "mg",
      category: "ingredient",
      description: "Focus and mental clarity",
    },
    ...
    huperzine_a_mcg: {
      ...
      unit: "mcg",
      category: "ingredient",
      description: "Memory enhancement",
    },
    uridine_monophosphate_mg: {
      displayName: "Uridine Monophosphate",
      unit: "mg",
      category: "ingredient",
  ...
  protein: {
    flavors: { displayName: "Available Flavors", unit: "", category: "info" },
    protein_claim_g: {
      displayName: "Protein Claim",
      unit: "g",
      category: "nutrition",
    },
    effective_protein_g: {
      displayName: "Effective Protein",
      unit: "g",
      category: "nutrition",
    },
    protein_sources: {
      displayName: "Protein Sources",
      unit: "",
      category: "info",
    },
  },
  ...
  bcaa: {
    ...
    l_isoleucine_mg: {
      ...
      unit: "mg",
      category: "amino",
      description: "Energy and glucose uptake",
    },
    l_valine_mg: {
      displayName: "L-Valine",
      unit: "mg",
      category: "amino",
      description: "Muscle growth and recovery",
    },
    l_lysine_hcl_mg: {
      displayName: "L-Lysine HCl",
      unit: "mg",
      category: "amino",
      description: "Collagen synthesis",
    },
    l_threonine_mg: {
    ...
    l_phenylalanine_mg: {
      ...
      unit: "mg",
      category: "amino",
      description: "Neurotransmitter synthesis",
    },
    l_tryptophan_mg: {
    ...
    l_histidine_hcl_mg: {
      displayName: "L-Histidine HCl",
      unit: "mg",
      category: "amino",
      description: "Histamine synthesis",
    },
    l_methionine_mg: {
      displayName: "L-Methionine",
      unit: "mg",
      category: "amino",
      description: "Antioxidant synthesis",
    },
    betaine_anhydrous_mg: {
      displayName: "Betaine Anhydrous",
      unit: "mg",
    ...
    coconut_water_powder_mg: {
      displayName: "Coconut Water Powder",
      unit: "mg",
      category: "ingredient",
      description: "Electrolyte replacement",
    },
    astragin_mg: {
      displayName: "Astragin",
      unit: "mg",
      category: "ingredient",
      description: "Absorption enhancement",
    },
  ...
  "fat-burner": {
    stimulant_based: {
      displayName: "Stimulant Based",
      unit: "",
      category: "info",
    },
    key_features: { displayName: "Key Features", unit: "", category: "info" },
    l_carnitine_l_tartrate_mg: {
      displayName: "L-Carnitine L-Tartrate",
      unit: "mg",
      category: "ingredient",
    ...
    green_tea_extract_mg: {
      ...
      unit: "mg",
      category: "ingredient",
      description: "Antioxidants and metabolism",
    },
    capsimax_mg: {
      displayName: "Capsimax",
      unit: "mg",
      category: "ingredient",
    ...
    ksm66_ashwagandha_mg: {
      displayName: "KSM-66 Ashwagandha",
      unit: "mg",
      category: "ingredient",
      description: "Stress reduction",
    },
    kelp_extract_mcg: {
      displayName: "Kelp Extract",
      unit: "mcg",
      category: "ingredient",
    ...
    zinc_picolinate_mg: {
      ...
      unit: "mg",
      category: "mineral",
      description: "Metabolism support",
    },
    five_htp_mg: {
      displayName: "5-HTP",
      unit: "mg",
      category: "ingredient",
      description: "Appetite suppression",
    },
    caffeine_anhydrous_mg: {
      displayName: "Caffeine Anhydrous",
      unit: "mg",
      category: "ingredient",
      description: "Energy and metabolism",
    },
    halostachine_mg: {
      displayName: "Halostachine",
      unit: "mg",
      category: "ingredient",
      description: "Fat burning",
    },
    rauwolscine_mcg: {
      displayName: "Rauwolscine",
      unit: "mcg",
      category: "ingredient",
      description: "Fat burning",
    },
