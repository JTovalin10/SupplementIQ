...
export default function CategoryPage({ categoryId, title, description, icon, color }: CategoryPageProps) {
    ...
    <>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
        <div className="flex items-center space-x-4 mb-4">
          <div className={`w-16 h-16 ${color} rounded-lg flex items-center justify-center text-white text-3xl`}>
            {icon}
          </div>
          <div>
